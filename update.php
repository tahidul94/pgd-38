     	...
     	<div class="row">
            ...
            <div class="col-md-7 right update-right">
                <div class="row">
                   ...
                   <div class="col-md-8">
                    <h3 class="wellcome">For update your data please give candidate User Id and Password</h3>
                   ...
                   <div class="col-md-12">
                     <form class="login-form" action="update_data.php" method="POST">
                        ...
                        <h4>Please Log in for update applicant Information</h4>
                    <div class="row">
                       ...
                       <div class="col-md-8">
                         <input type="text" class="address-input" name="userid"><br>           
                        </div>
                 ...
                 <input type="submit" name="submit" class="login-btn login" value="Update">
