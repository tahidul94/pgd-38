         ...
         <div class="container main">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                     ...
                     <form class="login-form" action="app_dwnld.php" method="POST">

                        <h4>Please Log in for your Application Id</h4>
                    <div class="row">
                 ...
                 <input type="submit" class="login-btn reset" name="reset" value="Reset">
